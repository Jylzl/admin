			...
			<div class="land-form">
				<el-form :model="landForm_password" ref="landForm_password" class="demo-ruleForm">
					<el-form-item prop="user" :rules="rules.user">
						<el-input
							type="text"
							v-model.number="landForm_password.user"
							autocomplete="off"
					...
					<el-form-item prop="pswd" :rules="rules.pswd">
						<div class="show-pswd">
							...
							></el-input>
							<el-button type="text" class="show-pswd-btn" title="显示密码">
								<i class="el-icon-view" @mousedown="showPswd('text')" @mouseup="showPswd('password')"></i>
							</el-button>
						</div>
					</el-form-item>
...
.land-box-center {
	...
	height: 542px;
	padding-left: 679px;
	background: #fff url(../../assets/img/account/land_bg_center.png) no-repeat
		center left;
